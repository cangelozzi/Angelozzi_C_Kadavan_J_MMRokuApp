          ...
          <v-flex xs12 v-if="myList.length">
            <v-card color="cyan darken-2" class="white--text" v-if="myList.length">
              ...
              <v-card-actions class="pa-3">
                FAVOURITE
                <v-spacer></v-spacer>
                <div class="text-xs-center" @click="favOn(myList[0].tv_id, myList[0].tv_fav, $event)">
          ...
          <v-flex xs12 v-if="myList.length">
            <v-card color="purple" class="white--text" v-if="myList.length">
              ...
              <v-card-actions class="pa-3">
                FAVOURITE
                <v-spacer></v-spacer>
                <div class="text-xs-center" @click="favOn(myList[1].tv_id, myList[1].tv_fav, $event)">
                  <p :style="{'isFavourite': fav}"><i @click="favOn()" class="fas fa-heart"></i></p>
                </div>
              </v-card-actions>
            </v-card>
          ...
          <v-flex xs12 v-if="myList.length">
            <v-card color="cyan darken-2" class="white--text" v-if="myList.length">
              ...
              <v-card-actions class="pa-3">
                FAVOURITE
                <v-spacer></v-spacer>
                <div class="text-xs-center" @click="favOn(myList[2].tv_id, myList[2].tv_fav, $event)">
                  <p :style="{'isFavourite': fav}"><i @click="favOn()" class="fas fa-heart"></i></p>
                </div>
              </v-card-actions>
            </v-card>
          ...
          <v-flex xs12 v-if="myList.length">
            <v-card color="purple" class="white--text" v-if="myList.length">
              ...
              <v-card-actions class="pa-3">
                FAVOURITE
                <v-spacer></v-spacer>
                <div class="text-xs-center" @click="favOn(myList[3].tv_id, myList[3].tv_fav, $event)">
                  <p :style="{'isFavourite': fav}"><i @click="favOn()" class="fas fa-heart"></i></p>
                </div>
              </v-card-actions>
            </v-card>
          ...
          <v-flex xs12 v-if="myPopular.length">
            <v-card color="cyan darken-2" class="white--text" v-if="myPopular.length">
              ...
              <v-card-actions class="pa-3">
                FAVOURITE
                <v-spacer></v-spacer>
                <div class="text-xs-center" @click="favOn(myPopular[0].tv_id, myPopular[0].tv_fav, $event)">
                  <p :style="{'isFavourite': fav}"><i @click="favOn()" class="fas fa-heart"></i></p>
                </div>
              </v-card-actions>
            </v-card>
          ...
          <v-flex xs12 v-if="myPopular.length">
            <v-card color="purple" class="white--text" v-if="myPopular.length">
              ...
              <v-card-actions class="pa-3">
                FAVOURITE
                <v-spacer></v-spacer>
                <div class="text-xs-center" @click="favOn(myPopular[1].tv_id, myPopular[1].tv_fav, $event)">
                  <p :style="{'isFavourite': fav}"><i @click="favOn()" class="fas fa-heart"></i></p>
                </div>
              </v-card-actions>
            </v-card>
          ...
          <v-flex xs12 v-if="myPopular.length">
            <v-card color="cyan darken-2" class="white--text" v-if="myPopular.length">
             ...
             <v-card-actions class="pa-3">
                FAVOURITE
                <v-spacer></v-spacer>
                <div class="text-xs-center" @click="favOn(myPopular[2].tv_id, myPopular[2].tv_fav, $event)">
                  <p :style="{'isFavourite': fav}"><i @click="favOn()" class="fas fa-heart"></i></p>
                </div>
              </v-card-actions>
            </v-card>
          ...
          <v-flex xs12 v-if="myPopular.length">
            <v-card color="purple" class="white--text" v-if="myPopular.length">
              ...
              <v-card-actions class="pa-3">
                FAVOURITE
                <v-spacer></v-spacer>
                <div class="text-xs-center" @click="favOn(myPopular[3].tv_id, myPopular[3].tv_fav, $event)">
                  <p :style="{'isFavourite': fav}"><i @click="favOn()" class="fas fa-heart"></i></p>
                </div>
              </v-card-actions>
            </v-card>
