          ...
          <v-flex xs12 v-if="myList.length">
            <v-card color="cyan darken-2" class="white--text" v-if="myList.length">
              ...
              <v-card-actions class="pa-3">
                FAVOURITE
                <v-spacer></v-spacer>
                <div class="text-xs-center" @click="favOn(myList[0].music_id, myList[0].music_fav, $event)">
          ...
          <v-flex xs12 v-if="myList.length">
            <v-card color="purple" class="white--text" v-if="myList.length">
              ...
              <v-card-actions class="pa-3">
                FAVOURITE
                <v-spacer></v-spacer>
                <div class="text-xs-center" @click="favOn(myList[1].music_id, yList[1].music_fav, $event)">
          ...
          <v-flex xs12 v-if="myList.length">
            <v-card color="cyan darken-2" class="white--text" v-if="myList.length">
              ...
              <v-card-actions class="pa-3">
                FAVOURITE
                <v-spacer></v-spacer>
                <div class="text-xs-center" @click="favOn(myList[2].music_id, myList[2].music_fav, $event)">
                  <p :style="{'isFavourite': fav}"><i @click="favOn()" class="fas fa-heart"></i></p>
                </div>
              </v-card-actions>
            </v-card>
          ...
          <v-flex xs12 v-if="myList.length">
            <v-card color="purple" class="white--text" v-if="myList.length">
              ...
              <v-card-actions class="pa-3">
                FAVOURITE
                <v-spacer></v-spacer>
                <div class="text-xs-center" @click="favOn(myList[3].music_id, myList[3].music_fav, $event)">
                  <p :style="{'isFavourite': fav}"><i @click="favOn()" class="fas fa-heart"></i></p>
                </div>
              </v-card-actions>
            </v-card>
          ...
          <v-flex xs12 v-if="myPopular.length">
            <v-card color="cyan darken-2" class="white--text" v-if="myPopular.length">
              ...
              <v-card-actions class="pa-3">
                FAVOURITE
                <v-spacer></v-spacer>
                <div class="text-xs-center" @click="favOn(myPopular[0].music_id, myPopular[0].music_fav, $event)">
                  <p :style="{'isFavourite': fav}"><i @click="favOn()" class="fas fa-heart"></i></p>
                </div>
              </v-card-actions>
            </v-card>
          ...
          <v-flex xs12 v-if="myPopular.length">
            <v-card color="purple" class="white--text" v-if="myPopular.length">
              ...
              <v-card-actions class="pa-3">
                FAVOURITE
                <v-spacer></v-spacer>
                <div class="text-xs-center" @click="favOn(myPopular[1].music_id, myPopular[1].music_fav, $event)">
                  <p :style="{'isFavourite': fav}"><i @click="favOn()" class="fas fa-heart"></i></p>
                </div>
              </v-card-actions>
            </v-card>
          ...
          <v-flex xs12 v-if="myPopular.length">
            <v-card color="cyan darken-2" class="white--text" v-if="myPopular.length">
              ...
              <v-card-actions class="pa-3">
                FAVOURITE
                <v-spacer></v-spacer>
                <div class="text-xs-center" @click="favOn(myPopular[2].music_id, myPopular[2].music_fav, $event)">
                  <p :style="{'isFavourite': fav}"><i @click="favOn()" class="fas fa-heart"></i></p>
                </div>
              </v-card-actions>
            </v-card>
          ...
          <v-flex xs12 v-if="myPopular.length">
            <v-card color="purple" class="white--text" v-if="myPopular.length">
              ...
              <v-card-actions class="pa-3">
                FAVOURITE
                <v-spacer></v-spacer>
                <div class="text-xs-center" @click="favOn(myPopular[3].music_id, myPopular[3].music_fav, $event)">
                  <p :style="{'isFavourite': fav}"><i @click="favOn()" class="fas fa-heart"></i></p>
                </div>
              </v-card-actions>
            </v-card>
