import UserNavHeaderComponent from "./UsersNavComponent";
export default {
  template: `
    <header>
      <usernavheadercomponent :navlist="navlist"></usernavheadercomponent>
  ...
  components: {
    usernavheadercomponent: UserNavHeaderComponent
  }
};
